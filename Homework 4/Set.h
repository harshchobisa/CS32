...
template<typename ItemType>
void unite(const ItemType& s1, const ItemType& s2, ItemType& result);
// result = { x | (x in s1) OR (x in s2) }

template<typename ItemType>
void subtract(const ItemType& s1, const ItemType& s2, ItemType& result);
// result = { x | (x in s1) AND NOT (x in s2) }

// Inline implementations
//template <typename ItemType> inline ItemType foo<ItemType>::bar(ItemType a)
template <typename ItemType>
...
//template <typename ItemType> ItemType foo<ItemType>::bar(ItemType a)
template <typename ItemType>
...
//template <typename ItemType> ItemType bar(ItemType a);
template <typename ItemType>
